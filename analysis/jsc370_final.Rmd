...
summary_var %>%
  ...
  knitr::kable(caption = "Summary Statistics for Variables in Merged Data Set") %>%
...
**Note**: For interactive visualizations of Figure 3, please refer to interactive visualizations [Figure 3](https://jennylin331431.github.io/jsc370-website/final_project_visuals.html#Figure_3:) on the website. 
