...
```{r}
#load data
leaflet_marker <- readRDS('final_project/data/leaflet_marker.rds')
sunshine_by_city <- readRDS('final_project/data/sunshine_by_city.rds')
sunshine_data <- readRDS('final_project/data/sunshine_data.rds')
```
...
This visualization shows the mean happiness score overtime in countries that participated in the Happiness report every year between 2010 to 2020. Trends are separated by income level, freedom level, and sunshine level. 
